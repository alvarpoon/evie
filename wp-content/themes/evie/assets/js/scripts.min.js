...
this._controls.$previous.toggle(e.nav),this._controls.$next.toggle(e.nav),e.dots){if(b=this._pages.length-this._controls.$indicators.children().length,e.dotData&&0!==b){for(c=0;c<this._controls.$indicators.children().length;c++)d+=this._templates[this._core.relative(c)];this._controls.$indicators.html(d)}else b>0?(d=new Array(b+1).join(this._templates[0]),this._controls.$indicators.append(d)):0>b&&this._controls.$indicators.children().slice(b).remove();this._controls.$indicators.find(".active").removeClass("active"),this._controls.$indicators.children().eq(a.inArray(this.current(),this._pages)).addClass("active")}this._controls.$indicators.toggle(e.dots)},e.prototype.onTrigger=function(b){var c=this._core.settings;b.page={index:a.inArray(this.current(),this._pages),count:this._pages.length,size:c&&(c.center||c.autoWidth||c.dotData?1:c.dotsEach||c.items)}},e.prototype.current=function(){var b=this._core.relative(this._core.current());return a.grep(this._pages,function(a){return a.start<=b&&a.end>=b}).pop()},e.prototype.getPosition=function(b){var c,d,e=this._core.settings;return"page"==e.slideBy?(c=a.inArray(this.current(),this._pages),d=this._pages.length,b?++c:--c,c=this._pages[(c%d+d)%d].start):(c=this._core.relative(this._core.current()),d=this._core.items().length,b?c+=e.slideBy:c-=e.slideBy),c},e.prototype.next=function(b){a.proxy(this._overrides.to,this._core)(this.getPosition(!0),b)},e.prototype.prev=function(b){a.proxy(this._overrides.to,this._core)(this.getPosition(!1),b)},e.prototype.to=function(b,c,d){var e;d?a.proxy(this._overrides.to,this._core)(b,c):(e=this._pages.length,a.proxy(this._overrides.to,this._core)(this._pages[(b%e+e)%e].start,c))},a.fn.owlCarousel.Constructor.Plugins.Navigation=e}(window.Zepto||window.jQuery,window,document),function(a,b,c,d){"use strict";var e=function(c){this._core=c,this._hashes={},this.$element=this._core.$element,this._handlers={"initialized.owl.carousel":a.proxy(function(){"URLHash"==this._core.settings.startPosition&&a(b).trigger("hashchange.owl.navigation")},this),"prepared.owl.carousel":a.proxy(function(b){var c=a(b.content).find("[data-hash]").andSelf("[data-hash]").attr("data-hash");this._hashes[c]=b.content},this)},this._core.options=a.extend({},e.Defaults,this._core.options),this.$element.on(this._handlers),a(b).on("hashchange.owl.navigation",a.proxy(function(){var a=b.location.hash.substring(1),c=this._core.$stage.children(),d=this._hashes[a]&&c.index(this._hashes[a])||0;return a?void this._core.to(d,!1,!0):!1},this))};e.Defaults={URLhashListener:!1},e.prototype.destroy=function(){var c,d;a(b).off("hashchange.owl.navigation");for(c in this._handlers)this._core.$element.off(c,this._handlers[c]);for(d in Object.getOwnPropertyNames(this))"function"!=typeof this[d]&&(this[d]=null)},a.fn.owlCarousel.Constructor.Plugins.Hash=e}(window.Zepto||window.jQuery,window,document),function(a){function b(){a(".toggle_connect").click(function(){a("#connect-popup").is(":visible")||a("#connect-popup").fadeIn()}),a(".toggle_connect_link").click(function(){a("#connect-popup").is(":visible")||a("#connect-popup").fadeIn()}),a("#connect_close").click(function(){a("#connect-popup").fadeOut()}),a(document).click(function(b){if(!a(b.target).closest("#connect-popup").length&&"connect_close"===b.target.id){if("toggle_connect"===b.target.id||"toggle_connect_link"===b.target.className)return void console.log(0);a("#connect-popup").fadeOut()}})}function c(){for(var a,b=[],c=window.location.href.slice(window.location.href.indexOf("?")+1).split("&"),d=0;d<c.length;d++)a=c[d].split("="),b.push(a[0]),b[a[0]]=a[1];return b}function d(b,c){-1===a.inArray(c,b)&&b.push(c)}function e(){function b(){a(".sort_order").each(function(){a(this).prop("checked",!1)}),a(".sort_order").each(function(){""!==j&&"undefined"!=typeof j?a(this).val()===j&&a(this).prop("checked",!0):"newest"===a(this).val()&&a(this).prop("checked",!0)})}function e(b,c){b.length>0?(a("."+c).each(function(){a(this).prop("checked",!1)}),a("."+c).each(function(){a.inArray(a(this).val(),b)>-1&&a(this).prop("checked",!0)})):a("."+c).each(function(){a(this).prop("checked",!0),d(b,a(this).val())})}function f(b,c){a("."+b+":checked").not("#"+c).length===a("."+b).not("#"+c).length?a("#"+c).prop("checked",!0):a("."+b+":checked").not("#"+c).length<a("."+b).not("#"+c).length&&a("#"+c).prop("checked",!1)}function g(){k="",l="",m="";for(var b=0;b<h.length;b++)""!==h[b]&&(k+=h[b]+",");k=k.slice(0,-1);for(var c=0;c<i.length;c++)""!==i[c]&&(l+=i[c]+",");l=l.slice(0,-1),m=a("input[name=sort_order]:checked").val();var d=full_url+"?product_cat="+k+"&concern_cat="+l+"&sorting="+m;window.location.href=d}var h=[],i=[],j="",k="",l="",m="";j=c().sorting;var n=c().product_cat,o=c().concern_cat;""!==n&&"undefined"!=typeof n&&(h=n.split(",")),""!==o&&"undefined"!=typeof o&&(i=o.split(",")),b(),e(h,"category_filter"),e(i,"concern_filter"),f("category_filter","category_all"),f("concern_filter","concern_all"),a(".category_filter").each(function(){"category_all"!==a(this).attr("id")&&a(this).prop("checked")&&-1===a.inArray(a(this).val(),h)&&h.push(a(this).val()),a(this).change(function(){if("category_all"===a(this).attr("id"))a(this).prop("checked")?(a(".category_filter").each(function(){d(h,a(this).val())}),g()):(a(".category_filter").each(function(){h=[0]}),g());else if(a(this).prop("checked"))d(h,a(this).val()),g();else{var b=a(this).val();h=jQuery.grep(h,function(a){return a!==b}),g()}})}),a(".concern_filter").each(function(){"concern_all"!==a(this).attr("id")&&a(this).prop("checked")&&-1===a.inArray(a(this).val(),i)&&i.push(a(this).val()),a(this).change(function(){if("concern_all"===a(this).attr("id"))a(this).prop("checked")?(a(".concern_filter").each(function(){a(this).prop("checked",!0),d(i,a(this).val())}),g()):(a(".concern_filter").each(function(){a(this).prop("checked",!1),i=[0]}),g());else if(a(this).prop("checked"))d(i,a(this).val()),g();else{var b=a(this).val();i=jQuery.grep(i,function(a){return a!==b}),g()}})}),a("input[name=sort_order]:radio").change(function(){g()})}var f={common:{init:function(){a(document).ready(function(){a(".subscribe-container a").fancybox({wrapCSS:"fancybox-custom",closeBtn:!0,openEffect:"none",padding:0,helpers:{title:{type:"inside"},overlay:{css:{background:"rgba(238,238,238,0.85)"}}}}),a(".no-hover>a").click(function(a){a.preventDefault()}),a("ul.dropdown-menu [data-toggle=dropdown]").on("click",function(b){b.preventDefault(),b.stopPropagation(),a(this).parent().hasClass("open")?(a(this).parent().removeClass("open"),a(this).parent().find("ul").parent().find("li.dropdown").removeClass("open")):(a(this).parent().addClass("open"),a(this).parent().find("ul").parent().find("li.dropdown").addClass("open"))}),b()})}},home:{init:function(){a(document).ready(function(){var b=a("#main-banner");b.owlCarousel({loop:!0,nav:!0,autoplay:!0,autoplayTimeout:5e3,autoplayHoverPause:!0,responsive:{0:{items:1}}}),a(".desktop-banner-prev").on("click",function(){b.trigger("prev.owl.carousel")}),a(".desktop-banner-next").on("click",function(){b.trigger("next.owl.carousel")});var c=a("#main-mobile-banner");c.owlCarousel({loop:!0,nav:!0,autoplay:!0,autoplayTimeout:5e3,autoplayHoverPause:!0,responsive:{0:{items:1}}}),a(".mobile-banner-prev").on("click",function(){c.trigger("prev.owl.carousel")}),a(".mobile-banner-next").on("click",function(){c.trigger("next.owl.carousel")})})}},about_us:{init:function(){}},media_coverage:{init:function(){a(".fancybox-effects-c").fancybox({wrapCSS:"fancybox-custom",closeBtn:!0,openEffect:"none",padding:0,helpers:{title:{type:"inside"},overlay:{css:{background:"rgba(238,238,238,0.85)"}}}})}},testimonials:{init:function(){a(document).ready(function(){e()})}}},g={fire:function(a,b,c){var d=f;b=void 0===b?"init":b,""!==a&&d[a]&&"function"==typeof d[a][b]&&d[a][b](c)},loadEvents:function(){g.fire("common"),a.each(document.body.className.replace(/-/g,"_").split(/\s+/),function(a,b){g.fire(b)})}};a(document).ready(g.loadEvents)}(jQuery);